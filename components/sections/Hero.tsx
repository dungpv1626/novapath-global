...
export default function Hero() {
  ...
  return (
    <section className="relative bg-navy text-[#e6eefb] overflow-hidden">
      ...
      <div className="relative max-w-[1220px] mx-auto px-[clamp(20px,5vw,56px)] grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-[54px] items-center"
        ...
        <div className="reveal reveal-d2 relative hidden lg:block">
          <div className="absolute inset-auto -right-[22px] -bottom-[26px] w-[62%] h-[62%] rounded-full -z-10"
            style={{ background: 'radial-gradient(circle,rgba(56,189,248,.4),transparent 70%)', filter: 'blur(30px)' }} />
          <Image
            src="/images/hero-banner-v2.jpg"
            alt="Học bổng du học Trung Quốc cùng NOVAPATH GLOBAL"
            width={1280}
            height={720}
            className="w-full rounded-[28px] shadow-[0_40px_80px_-30px_rgba(0,0,0,0.6)]"
            priority
          />
          {/* Float cards */}
          <div className="absolute top-[26px] -left-[26px] bg-white text-ink rounded-[16px] px-[18px] py-[14px] shadow-[0_24px_60px_-28px_rgba(15,40,95,0.30)] flex items-center gap-3 animate-[floaty_4.5s_ease-in-out_infinite_0.6s]">
          ...
          <div className="absolute bottom-[46px] -right-[22px] bg-white text-ink rounded-[16px] px-[18px] py-[14px] shadow-[0_24px_60px_-28px_rgba(15,40,95,0.30)] flex items-center gap-3 animate-[floaty_4.5s_ease-in-out_infinite]">
